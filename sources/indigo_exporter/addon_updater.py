...
class BitbucketEngine:
    ...
    def parse_tags(self, response, updater):
        ...
        return sorted([{"name": tag["name"], "zipball_url": self.get_zip_url(tag["name"], updater)} for tag in response["values"]], key=lambda s: list(map(int, s["name"].split('.'))), reverse=True)
